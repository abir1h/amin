      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text('Register As',style: TextStyle(color: Colors.black,fontSize: 28,fontWeight: FontWeight.bold),),
            SizedBox(height: 20,),
            InkWell(
              onTap: (){
            ...
            ),            Text('Doctor',style: TextStyle(color: Colors.black,fontSize: 28,fontWeight: FontWeight.bold),),
            SizedBox(height: 35,),
            InkWell(
              onTap: (){
            ...
            ),            Text('Patient',style: TextStyle(color: Colors.black,fontSize: 28,fontWeight: FontWeight.bold),),
