...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget _buildImage(String assetName, [double width = 350]) {
    return ShowUpAnimation( delayStart: Duration(milliseconds: 50),
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: IntroductionScreen(
        ...
        done: const Text('Get Started', style: TextStyle(fontWeight: FontWeight.w600,color: AppColors.base)),
        ...
        dotsDecorator: const DotsDecorator(
          ...
          activeSize: Size(22.0, 10.0),activeColor: AppColors.base,
