                     ...
                     child: Row(
                       children: [
                         ...
                         CircleAvatar(
                            ...
                            child: Container(
                              child: Text('Lv.2',style: TextStyle(
                                color: Colors.white
                              ),),
                            ),
                          ),
  ...
  child:   Column(
    ...
    children: [
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  child: Center(
                    child: Text('75 KG',style: TextStyle(
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  Text("Blood Preasure",style: TextStyle(
                    color: Colors.black,fontWeight: FontWeight.w700
                  ),)
                ],
              ),
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  child: Center(
                    child: Text('9,8',style: TextStyle(
                      color: Colors.white,fontWeight: FontWeight.bold

                    ),),
                  ),
                  ),
                  Text("Diabetics",style: TextStyle(
                    color: Colors.black,fontWeight: FontWeight.w700
                  ),)
                ],
              ),
      ...
      Padding(
        ...
        child: InkWell(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (_)=>prescription()));
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: SvgPicture.asset('assets/images/pr.svg',height: 20,width: 20,color: AppColors.base,),
                        ),
                      ),
                    ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text("Test Report",style: TextStyle(
                        color: AppColors.base,
                        fontWeight: FontWeight.bold,fontSize: 20
                    ),),
                  ],
      ...
      Padding(
        ...
        child: InkWell(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (_)=>test_schedule()));
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: SvgPicture.asset('assets/images/re.svg',height: 20,width: 20,color: AppColors.base,),
                        ),
                      ),
                    ),
                    Text("Test Schdule",style: TextStyle(
                        color: AppColors.base,
                        fontWeight: FontWeight.bold,fontSize: 20
                    ),),
                  ],
      ...
      Padding(
        ...
        child: InkWell(
          onTap: (){
            ...
            Navigator.push(context, MaterialPageRoute(builder: (_)=>medicine_s()));
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: SvgPicture.asset('assets/images/medicine.svg',height: 20,width: 20,color: AppColors.base,),
                        ),
                      ),
                    ),
                    Text("Medicine Schedule",style: TextStyle(
                        color: AppColors.base,
                        fontWeight: FontWeight.bold,fontSize: 20
                    ),),
                  ],
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Icon(Icons.info,color: AppColors.base,size: 20,)
                        ),
                      ),
                    ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Icon(Icons.settings ,color: AppColors.base,size: 20,)
                        ),
                      ),
                    ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Icon(Icons.logout ,color: AppColors.base,size: 20,)
                        ),
                      ),
                    ),
